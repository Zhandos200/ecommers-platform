...
type OrderServiceClient interface {
	...
	UpdateOrderStatus(ctx context.Context, in *StatusUpdate, opts ...grpc.CallOption) (*OrderResponse, error)
	ListOrders(ctx context.Context, in *UserOrdersRequest, opts ...grpc.CallOption) (*OrderList, error)
}
...
func (c *orderServiceClient) UpdateOrderStatus(ctx context.Context, in *StatusUpdate, opts ...grpc.CallOption) (*OrderResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(OrderResponse)
...
func (c *orderServiceClient) ListOrders(ctx context.Context, in *UserOrdersRequest, opts ...grpc.CallOption) (*OrderList, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(OrderList)
...
type OrderServiceServer interface {
	...
	UpdateOrderStatus(context.Context, *StatusUpdate) (*OrderResponse, error)
	ListOrders(context.Context, *UserOrdersRequest) (*OrderList, error)
...
func (UnimplementedOrderServiceServer) UpdateOrderStatus(context.Context, *StatusUpdate) (*OrderResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateOrderStatus not implemented")
}
func (UnimplementedOrderServiceServer) ListOrders(context.Context, *UserOrdersRequest) (*OrderList, error) {
...
func _OrderService_UpdateOrderStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServiceServer).UpdateOrderStatus(ctx, req.(*StatusUpdate))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _OrderService_ListOrders_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServiceServer).ListOrders(ctx, req.(*UserOrdersRequest))
	}
	return interceptor(ctx, in, info, handler)
}
